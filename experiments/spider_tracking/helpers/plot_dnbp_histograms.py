...
training_folder = "./experiments/spider_tracking/"
epoch = "epoch_74"
...
# plt.savefig(os.path.join(out_path, 'lbp_time_samples.jpg'), dpi=fig.dpi)
...
# plt.savefig(os.path.join(out_path, 'lbp_time_histograms.jpg'), dpi=fig.dpi)
...
deltas_02 = -bpn.edge_samplers[1](num_samples).cpu().detach()
deltas_03 = -bpn.edge_samplers[2](num_samples).cpu().detach()
deltas_14 = -bpn.edge_samplers[3](num_samples).cpu().detach()
deltas_25 = -bpn.edge_samplers[4](num_samples).cpu().detach()
deltas_36 = -bpn.edge_samplers[5](num_samples).cpu().detach()
...
# plt.savefig(os.path.join(out_path, 'lbp_pairwise_samples.jpg'), dpi=fig.dpi)
...
#     time_counts /= time_counts.max()
#     ax[i].imshow(time_counts, extent=[-1,1,-1,1])
# plt.savefig(os.path.join(out_path, 'lbp_pairwise_histograms.jpg'), dpi=fig.dpi)
